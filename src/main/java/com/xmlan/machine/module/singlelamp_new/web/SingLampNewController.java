package com.xmlan.machine.module.singlelamp_new.web;
 ...
 **/
@Controller
@RequestMapping("${adminPath}/singLampNew")
public class SingLampNewController extends BaseController {
    @Autowired
    private SingLampNewService singLampService;
    @Autowired
...
//    }
    ...
    public String form(Model model,@PathVariable int id){
        ...
        List<SingLampNew> singLamp = singLampService.findListByID(id);
    ...
    @ResponseBody
    public List<SingLampNew> singLampDetail(@PathVariable int id,RedirectAttributes redirectAttributes){
    ...
    String save(SingLampNew singLamp){

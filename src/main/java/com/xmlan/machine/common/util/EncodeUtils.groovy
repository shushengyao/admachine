...
class EncodeUtils {
    ...
    private static final def DEFAULT_URL_ENCODING = "UTF-8" as String
    private static final def BASE62 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".toCharArray()
